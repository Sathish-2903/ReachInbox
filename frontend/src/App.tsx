...
import { authApi, emailApi, slackApi } from './services/api.ts';
import { EmailItem, TabType, User } from './types/index.ts';
import {
  Send,
  Clock,
  CheckCircle,
...
export function App() {
  ...
  // Handle URL redirect query parameters for OAuth
  useEffect(() => {
    ...
    const slackParam = urlParams.get('slack_connected');
    if (slackParam) {
